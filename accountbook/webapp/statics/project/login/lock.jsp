...
<html lang="en">
    ...
    <head>
        ...
        <link href="../statics/assets/pages/css/lock-2.min.css" rel="stylesheet" type="text/css" />
        ...
        <div class="page-lock">
            <div class="page-logo">
                <a class="brand" href="index.html">
                    <img src="../statics/assets/pages/img/logo-big.png" alt="logo" /> </a>
            </div>
            <div class="page-body">
                <img class="page-lock-img" src="../statics/assets/pages/media/profile/profile.jpg" alt="">
...
<![endif]-->
        ...
        <script src="../statics/assets/pages/scripts/lock-2.min.js" type="text/javascript"></script>
